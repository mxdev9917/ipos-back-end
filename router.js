...
Router.route('/messages/filter')
    .post(middlewares.checkBodyNull, chatService.filterItemMessage)
Router.route('/admin/messages/count/:id')
.get(middlewares.checkID,chatService.countMessageAdmin)
